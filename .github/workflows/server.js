...
setInterval(() => {
  http.get(`http://winter-dull-pike.glitch.me/`);
}, 280000);
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity(`=help | test `, "http://twitch.tv/Rad-Bot"); ///تعديل مهم غير كلمة هيلب وبرميوم للوتشينق اللي بدك اياه مثل اسم سيرفرك
